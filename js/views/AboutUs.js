...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            ...
            <p>If you are interested in purchasing a puppy, or simply want more information, please feel free to contact us <a href="mailto:jill@goldenglories.com">here</a>!</p>
        `;
    }
